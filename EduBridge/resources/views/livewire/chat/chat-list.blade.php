            ...
            <li
             ...
             class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-100/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id==$selectedConversation?->id ? 'bg-gray-100/70':''}}">
                <a href="#" class="shrink-0">
                    @if ($conversation->getReceiver())
                    <x-avatar src="https://picsum.photos/500/500?face={{ $conversation->getReceiver()->id }}" />
                    @else
                        <x-avatar src="https://picsum.photos/500/500?face=default" />
                    @endif
                </a>
                                    ...
                                    function confirmDelete(conversationId) {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                @this.call('deleteByUser', conversationId);
                                                Swal.fire(
                                                    'Deleted!',
