...
class="w-full h-full overflow-hidden">
    ...
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b " >
        ...
        <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
            ...
            {{-- avatar --}}
            <div class="shrink-0">
                <x-avatar class="h-9 w-9 lg:w-11 lg:h-11" src="https://picsum.photos/500/500?face={{ $selectedConversation->getReceiver()->id }}" />
            </div>
    ...
    id="conversation"  class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class([
            ...
            <x-avatar src="https://picsum.photos/500/500?face={{ $selectedConversation->getReceiver()->id }}" />
        </div>
            {{-- messsage body --}}
            ...
            <div @class(['flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]',
                         ...
                         'rounded-br-none bg-purple-500/80 text-white'=>$message->sender_id=== auth()->id()
               ])>
            ...
            <img src="{{ Storage::url($message->media_path) }}" alt="Uploaded Image" style="max-width: 200px; border-radius: 10px;" />
            @endif
        ...
        <div class=" p-2 border-t">
            ...
            <form
             ...
             method="POST" autocapitalize="off">
                ...
                class="hidden" 
                x-ref="fileInput" 
                @change="media = $event.target.files[0]"/>
                     ...
                     <button x-bind:disabled="!body.trim() && !media"  class="col-span-2" type='submit'>Send</button>
